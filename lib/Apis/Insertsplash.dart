...
class InsertSplashscreen extends StatefulWidget {
  const InsertSplashscreen({super.key});

  @override
  State<InsertSplashscreen> createState() => _InsertSplashscreenState();
}

class _InsertSplashscreenState extends State<InsertSplashscreen>
  ...
  void initState() {
    ...
    Timer(const Duration(seconds: 3), () {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => const Insertapis()),
      );
    });
  }
